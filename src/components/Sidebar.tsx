...
export function Sidebar({ userEmail }: { userEmail: string | null }) {
  ...
  const links = [
    { href: "/bandeja", label: "Bandeja de entrada", icon: "inbox" as const },
    { href: "/contactos", label: "Contactos", icon: "contacts" as const },
    { href: "/precios", label: "Precios", icon: "prices" as const },
    { href: "/configuracion", label: "Configuración", icon: "settings" as const },
  ];

  return (
    <aside className="w-64 bg-f7panel border-r border-f7border flex flex-col shrink-0">
